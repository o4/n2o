...
open import n2o.Proto.Coinduction
...
{-# FOREIGN GHC
  fromColist :: MAlonzo.Code.Qn2o.Proto.Coinduction.AgdaColist a -> [a]
  fromColist    MAlonzo.Code.Qn2o.Proto.Coinduction.Nil        = []
  fromColist   (MAlonzo.Code.Qn2o.Proto.Coinduction.Cons x xs) = x : fromColist (MAlonzo.RTE.flat xs)
    
  toColist :: [a]  -> MAlonzo.Code.Qn2o.Proto.Coinduction.AgdaColist a
  toColist []       = MAlonzo.Code.Qn2o.Proto.Coinduction.Nil
  toColist (x : xs) = MAlonzo.Code.Qn2o.Proto.Coinduction.Cons x (MAlonzo.RTE.Sharp (toColist xs)) #-}
